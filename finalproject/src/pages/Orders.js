...
<FormControl component="fieldset">
  <RadioGroup aria-labelledby="demo-radio-buttons-group-label"
    ...
    name="radio-buttons-group" onChange={radiohandleChange}>
    <FormControlLabel value="sent" control={<Radio />} label="سفارش های تحویل شده" />
    <FormControlLabel value="pending" control={<Radio />} label="سفارش های در انتظار ارسال" />
      ...
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
       ...
       {/*  {products.map((product) => (
            ...
            >
              ...
              <TableCell align="center">{new Date(v.createdAt).getDay() + "/" + new Date(v.createdAt).getMonth() + "/" + new Date(v.createdAt).getFullYear()}</TableCell>
              <TableCell align="center">{ v.prices }</TableCell>
              <TableCell align="center">{v.username + " " + v.lastname}</TableCell>
